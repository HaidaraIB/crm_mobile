...
class _ProductsInventoryScreenState extends State<ProductsInventoryScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadProducts({bool forceRefresh = false}) async {
    ...
    try {
      ...
      setState(() {
        _errorProducts = ApiErrorHelper.toUserMessage(context, e);
        _isLoadingProducts = false;
      });
    }
  }
  ...
  Future<void> _loadCategories({bool forceRefresh = false}) async {
    ...
    try {
      ...
      setState(() {
        _errorCategories = ApiErrorHelper.toUserMessage(context, e);
        _isLoadingCategories = false;
      });
    }
  }
  ...
  Future<void> _loadSuppliers({bool forceRefresh = false}) async {
    ...
    try {
      ...
      setState(() {
        _errorSuppliers = ApiErrorHelper.toUserMessage(context, e);
        _isLoadingSuppliers = false;
      });
    }
  }
