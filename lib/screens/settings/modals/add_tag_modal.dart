...
Color parseTagColor(String hexColor) {
  try {
...
class AddTagModal extends StatefulWidget {
  ...
  const AddTagModal({super.key, this.onTagCreated});
    ...
    try {
      ...
      if (mounted) {
        ...
        SnackbarHelper.showSuccess(
          context,
          AppLocalizations.of(context)?.translate('tagCreatedSuccessfully') ??
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        localizations?.translate('addTag') ?? 'Add Tag',
...
/// Swatch picker shared by the add and edit tag modals.
class TagColorPickerRow extends StatelessWidget {
  final String selectedColor;
  final ValueChanged<String> onColorChanged;

  const TagColorPickerRow({
    super.key,
      ...
      children: [
        ...
        GestureDetector(
              ...
              builder: (context) => AlertDialog(
                ...
                content: SingleChildScrollView(
                  child: Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: kTagColorSwatches.map((hex) {
                      final color = parseTagColor(hex);
          ...
          child: Container(
            ...
            height: 50,
            decoration: BoxDecoration(
              color: parseTagColor(selectedColor),
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: Colors.grey),
            ),
          ),
        ...
        Expanded(
          child: Text(selectedColor, style: theme.textTheme.bodyMedium),
        ),
      ],
    );
  }
