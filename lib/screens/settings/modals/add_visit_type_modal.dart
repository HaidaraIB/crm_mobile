...
class AddVisitTypeModal extends StatefulWidget {
  ...
  const AddVisitTypeModal({super.key, this.onVisitTypeCreated});

  @override
  State<AddVisitTypeModal> createState() => _AddVisitTypeModalState();
}

class _AddVisitTypeModalState extends State<AddVisitTypeModal> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await _apiService.createVisitType(
      ...
      if (mounted) {
        widget.onVisitTypeCreated?.call();
        SnackbarHelper.showSuccess(
          context,
          AppLocalizations.of(context)?.translate('visitTypeCreatedSuccessfully') ??
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        localizations?.translate('addVisitType') ?? 'Add Visit Type',
                      ...
                      children: [
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText:
                                '${localizations?.translate('visitTypeName') ?? 'Visit type name'} *',
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(_selectedColor, style: theme.textTheme.bodyMedium),
                            ),
                          ],
                        ),
                        const SizedBox(height: 16),
