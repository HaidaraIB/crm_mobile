...
class EditVisitTypeModal extends StatefulWidget {
  ...
  const EditVisitTypeModal({
    super.key,
    required this.visitType,
    this.onVisitTypeUpdated,
  });

  @override
  State<EditVisitTypeModal> createState() => _EditVisitTypeModalState();
}

class _EditVisitTypeModalState extends State<EditVisitTypeModal> {
  ...
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.visitType.name);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        localizations?.translate('editVisitType') ?? 'Edit Visit Type',
