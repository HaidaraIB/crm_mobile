    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              AppLocalizations.of(context)?.translate('channelUpdatedSuccessfully') ?? 
      ...
      ErrorLogger().logError(
        error: e.toString(),
        endpoint: '/settings/channels/${widget.channel.id}/',
        method: 'PATCH',
      );
      if (mounted) {
        setState(() {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        localizations?.translate('editChannel') ?? 'Edit Channel',
