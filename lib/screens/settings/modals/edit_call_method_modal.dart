    ...
    try {
      ...
      if (mounted) {
        ...
        SnackbarHelper.showSuccess(
          context,
          AppLocalizations.of(context)?.translate('callMethodUpdatedSuccessfully') ??
              'Call method updated successfully',
        );
      }
    } catch (e) {
      ErrorLogger().logError(
        error: e.toString(),
        endpoint: '/settings/call-methods/${widget.callMethod.id}/',
        method: 'PATCH',
      );
      if (mounted) {
        setState(() {
