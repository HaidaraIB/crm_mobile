...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'softphoneCall': 'Softphone call',
      'softphoneCalling': 'Calling…',
      'softphoneRegistered': 'Registered',
      'softphoneConnecting': 'Connecting…',
      'softphoneOffline': 'Offline',
      'softphoneErrorTitle': 'Phone system unavailable',
      'softphoneErrorMic': 'Microphone access is required for calls. Enable it in Settings.',
      'softphoneErrorNotProvisioned': 'SIP credentials are missing. Ask your admin to set your extension password.',
      'softphoneErrorTransport': 'Could not connect to the phone server. Check network or contact admin.',
      'softphoneErrorRegistration': 'Could not register your extension. Verify password and that CooCall is logged out.',
      'softphoneErrorGeneric': 'Softphone could not start. Check network or contact admin.',
    ...
    'ar': {
      ...
      'softphoneCall': 'اتصال عبر السوفت فون',
      'softphoneCalling': 'جاري الاتصال…',
      'softphoneRegistered': 'متصل',
      'softphoneConnecting': 'جاري الاتصال…',
      'softphoneOffline': 'غير متصل',
      'softphoneErrorTitle': 'نظام الهاتف غير متاح',
      'softphoneErrorMic': 'يلزم الوصول للميكروفون للمكالمات. فعّله من الإعدادات.',
      'softphoneErrorNotProvisioned': 'بيانات SIP غير متوفرة. اطلب من المسؤول تعيين كلمة مرور الامتداد.',
      'softphoneErrorTransport': 'تعذر الاتصال بخادم الهاتف. تحقق من الشبكة أو تواصل مع المسؤول.',
      'softphoneErrorRegistration': 'تعذر تسجيل الامتداد. تحقق من كلمة المرور وتأكد من تسجيل خروج CooCall.',
      'softphoneErrorGeneric': 'تعذر تشغيل السوفت فون. تحقق من الشبكة أو تواصل مع المسؤول.',
