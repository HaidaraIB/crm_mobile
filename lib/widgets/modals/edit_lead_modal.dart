...
class _EditLeadModalState extends State<EditLeadModal> {
  ...
  void _initializeForm() {
    ...
    _budgetController.text = widget.lead.budget > 0 ? widget.lead.budget.toString() : '';
    ...
    _selectedUserId = widget.lead.assignedTo > 0 ? widget.lead.assignedTo : null;
    
    if (widget.lead.phoneNumbers != null && widget.lead.phoneNumbers!.isNotEmpty) {
      _phoneNumbers = widget.lead.phoneNumbers!.map((pn) => {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final primaryPhone = phoneNumbers.firstWhere(
        (p) => p['is_primary'] == true,
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              AppLocalizations.of(context)?.translate('leadUpdatedSuccessfully') ?? 
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  hintText: localizations?.translate('enterClientName') ?? 'Enter client name',
                                ...
                                validator: (value) {
                                  if (value == null || value.trim().isEmpty) {
                                    return localizations?.translate('pleaseEnterClientName') ?? 
                              ...
                              // Budget
                              Text(
                                localizations?.translate('budget') ?? 'Budget',
                                style: theme.textTheme.titleMedium,
                              ),
                              const SizedBox(height: 8),
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  hintText: localizations?.translate('enterBudget') ?? 'Enter budget',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(12),
                                  ),
                                ),
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                items: [
                                  ...
                                  ..._channels.map((channel) => DropdownMenuItem(
                                        value: channel.name,
