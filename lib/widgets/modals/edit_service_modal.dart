...
class _EditServiceModalState extends State<EditServiceModal> {
  ...
  void initState() {
    ...
    _selectedProvider = widget.service.provider;
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)?.translate('serviceUpdated') ?? 'Service updated successfully'),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      localizations?.translate('editService') ?? 'Edit Service',
